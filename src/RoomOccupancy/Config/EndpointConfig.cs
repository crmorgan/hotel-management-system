...
{
	[EndpointName("HotelManagementSystem.RoomOccupancy")]
	public class EndpointConfig : IConfigureThisEndpoint, AsA_Server
	{
		...
		private void InitializeDatbase()
		{
			...
			var context = new RoomOccupancyContext();
		...
		public void Customize(EndpointConfiguration endpointConfiguration)
		{
			...
			//    .ConnectionString(ConfigurationManager.ConnectionStrings["HotelManagementSystem.RoomOccupancy"].ToString());
